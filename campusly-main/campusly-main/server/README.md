# Campusly Backend Server

A robust Node.js backend API server for the Campusly placement management system. Built with Express.js, MongoDB, and comprehensive authentication features.
...
3. **Environment Configuration**
   ...
   DB_CONNECTION_STRING=mongodb+srv://<username>:<password>@cluster.mongodb.net/Campusly
   LOCAL_DB_CONNECTION_STRING=mongodb://localhost:27017/Campusly
