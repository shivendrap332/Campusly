...
gh api repos/MCA-NITW/Campusly/actions/permissions \
  --method PUT \
  --field enabled=true \
  --field allowed_actions=all

# Set workflow permissions
gh api repos/MCA-NITW/Campusly/actions/permissions/workflow \
  --method PUT \
...
1. **Check Repository Settings**:
   ```
   https://github.com/MCA-NITW/Campusly/settings/actions
   ```
