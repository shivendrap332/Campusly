			...
			<div className="teams-container">
				...
				<section className="hero-section animate-fadeInUp">
					<div className="hero-content">
						...
						<p className="hero-subtitle animate-fadeInUp animate-delay-400">
							Passionate B.Tech full-stack developers with hands-on experience
							in MERN stack, building real-world systems like placement and
							management platforms with a strong focus on performance,
							scalability, and practical problem-solving.
						</p>
				...
				<section className="team-members animate-fadeInUp animate-delay-600">
					<div className="section-header">
						...
						<p className="section-subtitle">
							Meet the talented individuals behind Campusly
						</p>
					</div>
								...
								<div className="contributions-section">
									...
									<ul className="contributions-list">
										{member.projectContributions
											.slice(0, 3)
											.map((contribution) => (
												<li key={contribution.substring(0, 20)}>
													{contribution}
												</li>
											))}
									</ul>
				...
				<section className="project-highlights animate-fadeInUp animate-delay-1200">
					<div className="section-header">
						...
						<p className="section-subtitle">
							What makes our placement management system special
						</p>
					</div>
						...
						{[
							{
								...
								description:
									'JWT-based authentication with email verification and role-based access control ensuring data security.',
							},
							{
								icon: '📱',
							...
							},
							{
								...
								description:
									'Live data synchronization and instant notifications for placement activities and updates.',
							},
							{
								icon: '📈',
								title: 'Advanced Analytics',
								description:
									'Comprehensive dashboard with detailed statistics, trends, and insights for informed decision making.',
							},
							{
								icon: '🎯',
								title: 'User-Centric Design',
								description:
									'Intuitive interface designed with student and admin needs in mind for optimal user experience.',
							},
							{
								icon: '🔄',
								title: 'Scalable Architecture',
								description:
									'Built with modern MERN stack ensuring scalability and maintainability for future enhancements.',
							},
						].map((highlight, index) => (
							<div
								key={highlight.title}
