	...
	const fetchStats = async () => {
		try {
			...
			const [studentResponse, companyResponse, ctcResponse] = await Promise.all(
				[getStudentStats(), getCompanyStats(), getCtcStats()]
			);
		...
		<div className="container home-container">
			...
			<div className="home-hero">
				...
				<div className="home-header">
					<h1 className="home-title">
						Welcome to <span className="highlight-text">Campusly</span>
					</h1>
			...
			<div className="stats-dashboard">
				...
				{statsError ? (
					<div className="stats-error">
						<p>Sign in to view live statistics</p>
						<button
						...
						<div className="stat-card student-stats">
							...
							<div className="stat-content">
								...
								<span className="stat-percentage">
									{stats.students.percentage}% Placed
								</span>
							</div>
						</div>
			...
			<div className="hero-banner">
				...
				<div className="hero-content">
					...
					<p>
						Experience the future of placement management with cutting-edge
						technology
					</p>
				</div>
			</div>
			...
			<div className="home-features">
				...
				<div className="features-grid">
					<div className="feature-card card-3d">
						...
						<p>
							AI-powered insights with real-time data visualization and
					...
					<div className="feature-card card-3d">
						...
						<p>
							Intelligent profile management with automated matching and career
							recommendations
						</p>
					...
					<div className="feature-card card-3d">
						...
						<p>
							Direct integration with 500+ companies and real-time job
							opportunity updates
						</p>
					...
					<div className="feature-card card-3d">
						...
						<p>
							Community-driven platform with verified reviews and interview
							preparation tools
						</p>
					...
					<div className="feature-card card-3d">
						...
						<p>
							Optimized performance with instant updates and real-time
							notifications
						</p>
					...
					<div className="feature-card card-3d">
						...
						<h3>Goal Tracker</h3>
						<p>
							Personal achievement tracking with milestone celebrations and
							progress analytics
						</p>
			...
			<div className="success-ticker">
				<div className="ticker-content">
					<span>
						🎉 Rahul got placed at Google • 💰 Priya secured 15L CTC • 🚀 Amit
						joined Microsoft • 🌟 Sneha got dream job at Amazon •{' '}
					</span>
				</div>
			</div>
			...
			<div className="home-cta">
				...
				<div className="cta-content">
					...
					<p className="cta-text">
						Join 10,000+ students who transformed their careers with Campusly
					</p>
